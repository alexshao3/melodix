...
export function ArtistCard({ artist, onClick, index }: ArtistCardProps) {
  return (
    <motion.button
      ...
      className="group flex w-full flex-col items-center gap-3 rounded-2xl bg-white/[0.03] p-4 text-center transition-[transform,background-color] duration-200 hover:-translate-y-1 hover:bg-white/[0.06]"
    >
