...
| `StorageModule`         | `storage/`             | S3-compatible upload/delete via `@aws-sdk/client-s3`. Defaults tuned for Backblaze B2 (free, no card); same code works for R2/Storj/MinIO/AWS S3. | (internal)                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
