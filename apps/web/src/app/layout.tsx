...
// Inter (body) + Fraunces (display, with the SOFT/WONK axes that give the
// brand voice its distinctive character). Both shipped via @fontsource-
// variable so `next build` does not need to fetch from fonts.googleapis.com
// — important for self-hosted Docker builds behind firewalls / Cloudflare
// Tunnel where outbound DNS to Google can fail (see ADR-0027). Tailwind
// reads `var(--font-sans)` / `var(--font-display)`.
